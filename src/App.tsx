                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
                    ...
                    <div className="bg-slate-950 border border-slate-850 p-4 rounded-xl space-y-3 font-mono text-xs">
                      <div>
                        <span className="text-2xs font-semibold uppercase tracking-wide text-slate-400">REST API Endpoint URI (Trigger URL)</span>
                        <div className="flex items-center justify-between gap-2 bg-slate-900 px-3 py-2 rounded-lg border border-slate-800/80 mt-1">
                          <div className="flex gap-2 text-slate-300 select-all truncate">
                      ...
                      {/* Curl Command generation block */}
                      <div>
                        <span className="text-2xs font-semibold uppercase tracking-wide text-slate-400">cURL Terminal command</span>
                        <div className="flex items-center justify-between gap-2 bg-slate-900 px-3 py-2 rounded-lg border border-slate-800/80 mt-1">
                          <code className="text-indigo-400 select-all truncate font-mono text-2xs">
